...
def test_electric_transport():
    el_tr = ElectricTransport("t_el_transport", 120_000_000, 1000, "Gas")
...
def test_air_transport():
    air_tr = AirTransport("air_transport", 107_000_000, 900, 10_000)
...
def test_train():
    train = Train("t_train", 200_000_000, 400, "555M", 75)
...
def test_air_balloon():
    air_balloon = AirBalloon("air_balloon", 1_000_000, 200, 5_000, 70)
